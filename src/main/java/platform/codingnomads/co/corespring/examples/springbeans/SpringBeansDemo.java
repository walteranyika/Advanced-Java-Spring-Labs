...
public class SpringBeansDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Spring Developer Address: " + springDeveloper.getAddress().getStreetNumber() + " " +
                springDeveloper.getAddress().getStreet() + " Profile: Language" + springDeveloper.getProfile().getLanguage()
                + " With " + springDeveloper.getProfile().getYearsOfExperience()+" Year(s) Of Experience");
    }
}